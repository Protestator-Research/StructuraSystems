...
namespace StructuraSystems::Client {
    ...
    std::vector<std::shared_ptr<KerML::Entities::Element>> StructuraSystemsParser::readFile(QString filePath) {
    ...
    std::vector<std::shared_ptr<KerML::Entities::Element>> StructuraSystemsParser::readMarkdownFile(QString filePath) {
        MarkdownParser parser;
        parser.parseMarkdownFile(filePath);
        return parser.getElementsOfProject();
    }

    std::vector<std::shared_ptr<KerML::Entities::Element>> StructuraSystemsParser::readXmlFile(QString ) {
    ...
    std::vector<std::shared_ptr<KerML::Entities::Element>> StructuraSystemsParser::readJsonFile(QString ) {
        return std::vector<std::shared_ptr<KerML::Entities::Element>>();
    }
    ...
    void StructuraSystemsParser::writeXmlFile(QString , std::vector<std::shared_ptr<KerML::Entities::Element>> ) {
